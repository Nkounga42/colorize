...
const ColorInput = ({ value = "#345645", onChange }) => {
  ...
  // Ne met à jour que si value parent change
  useEffect(() => {
  ...
  // Debounced version de onChange pour éviter de spammer
...
const defaultVisualProperties = {
  ...
  shadow: { color: "#000000", x: 0, y: 4, blur: 4, spread: 0, opacity: 0.25 },
};

const [visualProperties, setVisualProperties] = useState(defaultVisualProperties);
...
useEffect(() => {
  if (
    ...
    const merged = {
      ...
      ...visualPropertiesFromParent,
      text: {
        ...defaultVisualProperties.text,
        ...(visualPropertiesFromParent?.text || {})
      },
      fill: {
        ...defaultVisualProperties.fill,
        ...(visualPropertiesFromParent?.fill || {})
      },
      stroke: {
        ...defaultVisualProperties.stroke,
        ...(visualPropertiesFromParent?.stroke || {})
      },
      shadow: {
        ...defaultVisualProperties.shadow,
        ...(visualPropertiesFromParent?.shadow || {})
      }
    };
    setVisualProperties(merged);
  }
...
const updateVisualProperty = (path, value) => {
  setVisualProperties((prev) => {
    ...
    onStyleChange(newProps); // callback vers parent
    return newProps;
  });
};
                    ...
                    <div className="form-control">
                      <label className="label">
                        <span className="label-text ">
                          Opacité:{" "}
                          {Math.round(visualProperties.fill.opacity * 100)}%
                        </span>
                      </label>
                      <input
                        type="range"
                ...
                <div className="">
                  ...
                  <div className="space-y-3">
                    <ColorInput 
                      ...
                      onChange={(color) => updateVisualProperty("stroke.color", color)} 
                    />
                    <div className="form-control">
                      <label className="label">
                        <span className="label-text ">
                    ...
                    <div className="form-control">
                      <label className="label">
                        <span className="label-text ">
                          Opacité:{" "}
                          {Math.round(visualProperties.stroke.opacity * 100)}%
                        </span>
                      </label>
                      <input
                        type="range"
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="form-control">
                        ...
                        <input
                          ...
                          min="-20"
                          max="20"
                          value={visualProperties.shadow.x}
                          onChange={(e) =>
                            updateVisualProperty(
                              "shadow.x",
                              Number(e.target.value)
                      ...
                      <div className="form-control">
                        ...
                        <input
                          ...
                          min="-20"
                          max="20"
                          value={visualProperties.shadow.y}
                          onChange={(e) =>
                            updateVisualProperty(
                              "shadow.y",
                              Number(e.target.value)
                      ...
                      <div className="form-control">
                        ...
                        <input
                          ...
                          min="0"
                          max="20"
                          value={visualProperties.shadow.blur}
                          onChange={(e) =>
                            updateVisualProperty(
                              "shadow.blur",
                              Number(e.target.value)
                      ...
                      <div className="form-control">
                        ...
                        <input
                          ...
                          min="0"
                          max="10"
                          value={visualProperties.shadow.spread}
                          onChange={(e) =>
                            updateVisualProperty(
                              "shadow.spread",
                              Number(e.target.value)
                    ...
                    <div className="form-control">
                      <label className="label">
                        <span className="label-text ">
                          Opacité:{" "}
                          {Math.round(visualProperties.shadow.opacity * 100)}%
                        </span>
                      </label>
                      <input
                        type="range"
                ...
                <div className="">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-1">
                      ...
                      <button
                        onClick={() =>
                          updateVisualProperty("text.align", "left")
                        }
                        className={`btn btn-ms ${
                      ...
                      <button
                        onClick={() =>
                          updateVisualProperty("text.align", "center")
                        }
                        className={`btn btn-ms ${
                      ...
                      <button
                        onClick={() =>
                          updateVisualProperty("text.align", "right")
                        }
                        className={`btn btn-ms ${

...
const Drawing = () => {
  ...
  return (
    <div className="flex h-screen relative bg-base-300">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div
          ...
          onDrop={(e) => {
            ...
            if (url && canvas && window.fabric && canvasRef.current) {
              window.fabric.Image.fromURL(url, (img) => {
                const maxDimension = 300;
                const scale = Math.min(
                  maxDimension / img.width!,
                ...
                // Récupère la position relative à la zone du canvas HTML
      ...
      {/* <ZoomControls canvas={canvas} />yy */}
    </div>
  );
};

// Composant Toolbar séparé
// Composant LayersPanel séparé
